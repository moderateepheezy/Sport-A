 ...
 */
public class BaseActivity extends ActionBarActivity implements ApplicationSessionStateCallback {
    ...
    private void recreateSession(final QBUser user){
        ...
        // Restoring ChatActivity session
        //
        ChatService.getInstance().login(user, new QBEntityCallbackImpl() {
            @Override
            public void onSuccess() {
                Log.d(TAG, "ChatActivity login onSuccess");
            ...
            public void onError(List errors) {
                ...
                Log.d(TAG, "ChatActivity login onError: " + errors);
